...
// HTTPAmfContext3gpp - To modify the AMF context data of a UE using 3gpp access in the NWDAF
...
// HTTPCreateAmfContext3gpp - To store the AMF context data of a UE using 3gpp access in the NWDAF
