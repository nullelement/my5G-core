...
// HTTPAmfContextNon3gpp - To modify the AMF context data of a UE using non 3gpp access in the NWDAF
...
// HTTPCreateAmfContextNon3gpp - To store the AMF context data of a UE using non-3gpp access in the NWDAF
