...
type NfLoadLevelInformation struct {
	NfType map[string]interface{} `json:"nfType"`
	NfInstanceId map[string]interface{} `json:"nfInstanceId"`
	NfSetId *map[string]interface{} `json:"nfSetId,omitempty"`
...
// SetNfSetId gets a reference to the given map[string]interface{} and assigns it to the NfSetId field.
