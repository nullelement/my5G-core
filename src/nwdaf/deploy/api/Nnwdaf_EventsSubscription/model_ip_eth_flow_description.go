...
type IpEthFlowDescription struct {
	IpTrafficFilter *map[string]interface{} `json:"ipTrafficFilter,omitempty"`
	EthTrafficFilter *map[string]interface{} `json:"ethTrafficFilter,omitempty"`
}
...
// SetIpTrafficFilter gets a reference to the given map[string]interface{} and assigns it to the IpTrafficFilter field.
...
// SetEthTrafficFilter gets a reference to the given map[string]interface{} and assigns it to the EthTrafficFilter field.
