...
type NfStatus struct {
	StatusRegistered *map[string]interface{} `json:"statusRegistered,omitempty"`
	StatusUnregistered *map[string]interface{} `json:"statusUnregistered,omitempty"`
	StatusUndiscoverable *map[string]interface{} `json:"statusUndiscoverable,omitempty"`
}
...
// SetStatusRegistered gets a reference to the given map[string]interface{} and assigns it to the StatusRegistered field.
...
// SetStatusUnregistered gets a reference to the given map[string]interface{} and assigns it to the StatusUnregistered field.
...
// SetStatusUndiscoverable gets a reference to the given map[string]interface{} and assigns it to the StatusUndiscoverable field.
