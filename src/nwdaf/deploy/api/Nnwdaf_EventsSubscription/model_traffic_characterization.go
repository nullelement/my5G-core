...
type TrafficCharacterization struct {
	...
	UlVol *map[string]interface{} `json:"ulVol,omitempty"`
	UlVolVariance *map[string]interface{} `json:"ulVolVariance,omitempty"`
	DlVol *map[string]interface{} `json:"dlVol,omitempty"`
	DlVolVariance *map[string]interface{} `json:"dlVolVariance,omitempty"`
}
...
// SetUlVol gets a reference to the given map[string]interface{} and assigns it to the UlVol field.
...
// SetUlVolVariance gets a reference to the given map[string]interface{} and assigns it to the UlVolVariance field.
...
// SetDlVol gets a reference to the given map[string]interface{} and assigns it to the DlVol field.
...
// SetDlVolVariance gets a reference to the given map[string]interface{} and assigns it to the DlVolVariance field.
