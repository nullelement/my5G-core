...
type TargetUeInformation struct {
	...
	IntGroupIds *[]map[string]interface{} `json:"intGroupIds,omitempty"`
}
...
// SetIntGroupIds gets a reference to the given []map[string]interface{} and assigns it to the IntGroupIds field.
