...
type RetainabilityThreshold struct {
	RelFlowNum *map[string]interface{} `json:"relFlowNum,omitempty"`
	RelTimeUnit *TimeUnit `json:"relTimeUnit,omitempty"`
	RelFlowRatio *map[string]interface{} `json:"relFlowRatio,omitempty"`
}
...
// SetRelFlowNum gets a reference to the given map[string]interface{} and assigns it to the RelFlowNum field.
...
// SetRelFlowRatio gets a reference to the given map[string]interface{} and assigns it to the RelFlowRatio field.
