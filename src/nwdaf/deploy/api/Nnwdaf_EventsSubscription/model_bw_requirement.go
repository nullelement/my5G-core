...
type BwRequirement struct {
	AppId map[string]interface{} `json:"appId"`
	MarBwDl *map[string]interface{} `json:"marBwDl,omitempty"`
	MarBwUl *map[string]interface{} `json:"marBwUl,omitempty"`
	MirBwDl *map[string]interface{} `json:"mirBwDl,omitempty"`
	MirBwUl *map[string]interface{} `json:"mirBwUl,omitempty"`
}
...
// SetMarBwDl gets a reference to the given map[string]interface{} and assigns it to the MarBwDl field.
...
// SetMarBwUl gets a reference to the given map[string]interface{} and assigns it to the MarBwUl field.
...
// SetMirBwDl gets a reference to the given map[string]interface{} and assigns it to the MirBwDl field.
...
// SetMirBwUl gets a reference to the given map[string]interface{} and assigns it to the MirBwUl field.
